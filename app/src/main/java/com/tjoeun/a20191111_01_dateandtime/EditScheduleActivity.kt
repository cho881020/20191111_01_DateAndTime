...
import com.tjoeun.a20191111_01_dateandtime.adapters.SchduleTypeSpinnerAdapter
...
class EditScheduleActivity : BaseActivity() {
    ...
    var scheduleTypeSpinnerAdapter:SchduleTypeSpinnerAdapter? = null
...
//                    버튼에 sdf를 이용해서 선택된 날짜를 String으로 변환
                ...
                startDateTimeCalenar.get(Calendar.YEAR),
                startDateTimeCalenar.get(Calendar.MONTH),
                startDateTimeCalenar.get(Calendar.DAY_OF_MONTH))
        ...
        startTimeBtn.setOnClickListener {
            var timePickerDialog = TimePickerDialog(this,
                ...
                startDateTimeCalenar.get(Calendar.HOUR_OF_DAY),
                startDateTimeCalenar.get(Calendar.MINUTE),
                false)
    ...
    override fun setValues() {
        ...
        scheduleTypeSpinnerAdapter = SchduleTypeSpinnerAdapter(this, scheduleTypeList)
